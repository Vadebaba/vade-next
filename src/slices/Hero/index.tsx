    ...
    >
      <div className="grid pt-8 min-h-[60vh] grid-cols-1 md:grid-cols-2 items-center ">
       ...
       <Avatar
          ...
          className="row-start-1 max-w-[20rem] md:col-start-2 md:row-end-3"
        />
        <div className="col-start-1 md:row-start-1">
          <h1
            className="mb-8 text-[clamp(3rem,20vmin,20rem)] font-bold 
          ...
          >
            ...
            <span className="job-title block bg-gradient-to-tr from-yellow-500 via-yellow-200
